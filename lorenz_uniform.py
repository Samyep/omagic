...
def parse_args(argv):
    ap = argparse.ArgumentParser(description="Change-point detection runner for Lorenz with uniform rho change-points.")
    ...
    ap.add_argument("--stop", type=int, default=950, help="exclusive stop index of observation slice (default matches generated data).")
    ...
    ap.add_argument("--prefix", type=str, default="lorenz_uniform_run", help="prefix for output files.")
    ...
    ap.add_argument("--model", type=str, default="lorenz_uniform", help="Model to use (default: lorenz_uniform).")
